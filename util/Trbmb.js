...
module.exports = class TRBMB {
    ...
    get trbmb() {
        return this.makeTrbmb()
    }
    makeTrbmb() {
        let phrase = ""

        for (let i = 0; i < 4; i++) {
            phrase = phrase + this.lines[i][(Math.floor(Math.random() * this.lines[i].length))]
        }
